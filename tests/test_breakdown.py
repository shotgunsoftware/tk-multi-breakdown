...
class TestApplication(TankTestBase):
    ...
    def setUp(self):
        ...
        #
        #
        os.environ["BUNDLE_ROOT"] = os.path.abspath(
...
class TestApi(TestApplication):
    ...
    def test_compute_highest_version(self):
        ...
        # test logic
        self.assertEqual(
            self.app.compute_highest_version(item["template"], item["fields"]), 4
        )
        # test bad data
        self.assertRaises(
            TankError,
